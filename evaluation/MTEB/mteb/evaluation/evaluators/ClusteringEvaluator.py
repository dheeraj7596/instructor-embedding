...
#         'TwentyNewsgroupsClustering': 'even more than his asking questions: ',
#         'BiorxivClusteringS2S': 'wouldn’t fall back on their favourite hobby: ',
#         'MedrxivClusteringS2S': 'even more than his asking questions: ',
#         'ArxivClusteringP2P': 'the entrance and then, because the smiling: ',
#         'ArxivClusteringS2S': 'ate in the zoo restaurant and when Dudley: ',
#         'BiorxivClusteringP2P': 'cheap lemon ice lolly. It wasn’t bad: ',
#         'MedrxivClusteringP2P': 'head and looking remarkably like Dudley: ',
#         'RedditClustering': 'wished he hadn’t said anything: ',
#         'RedditClusteringP2P': 'at the moment it didn’t look in the mood.: ',
#         'StackExchangeClustering': 'Harry what he wanted before they could: ',
#         'StackExchangeClusteringP2P': 'wished he hadn’t said anything: ',
#     },
# }
...
#     # },
#     'hkunlp/instructor-base': {
#         'TwentyNewsgroupsClustering': 'Represent the tweet post for retrieving duplicate comments: ',
#         'BiorxivClusteringS2S': 'Represent the tweet post for retrieving duplicate comments: ',
#         'MedrxivClusteringS2S': 'Represent the tweet post for retrieving duplicate comments: ',
#         'ArxivClusteringP2P': 'Represent the tweet post for retrieving duplicate comments: ',
#         'ArxivClusteringS2S': 'Represent the tweet post for retrieving duplicate comments: ',
#         'BiorxivClusteringP2P': 'Represent the tweet post for retrieving duplicate comments: ',
#         'MedrxivClusteringP2P': 'Represent the tweet post for retrieving duplicate comments: ',
#         'RedditClustering': 'Represent the tweet post for retrieving duplicate comments: ',
#         'RedditClusteringP2P': 'Represent the tweet post for retrieving duplicate comments: ',
#         'StackExchangeClustering': 'Represent the tweet post for retrieving duplicate comments: ',
#         'StackExchangeClusteringP2P': 'Represent the tweet post for retrieving duplicate comments: ',
#     },
# }
DEFINITIONS = {
    # 'hkunlp/instructor-xl': {
